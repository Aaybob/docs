...
You first need to install the base openaps toolkit and its dependencies. If you are starting here with a pre-flashed jubilinux compute module ##stop##. The first thing to do is in section 1-4 Install Packages.
